...
import { GridModule, ButtonModule,
  ...
  SideNavModule, TilesModule,
  TabsModule, UIShellModule, PanelModule, DialogModule, DropdownModule, ModalService, PlaceholderModule } from 'carbon-components-angular';
...
@NgModule({
  ...
  providers: [AngularFirestore, AngularFireMessaging, ModalService],
